...
s1 = prng.sine_distribution(Enable_Random_Seed = 1,  Seed = 10, Ntrials = 10000000, Ncycles = 1,  N_Integrations = 10,   Nbins = 3000)
s2 = prng.sine_distribution(Enable_Random_Seed = 1,  Seed = 10, Ntrials = 10000000, Ncycles = 1,  N_Integrations = 10,   Nbins = 3000)
...
plt.title("wave distribution", color = 'white')
