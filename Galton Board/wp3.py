...
#sim_quadratic_potential = simulate(wave_packet(mom=30),V=quadratic_potential,steps=40000,save_every=500)
...
#anim = animate(sim_quadratic_potential,quadratic_init)
#anim = animate(sim_quad_0,init_func=quadratic_init)
#anim = animate(sim_free)
sim_quad_0 = simulate(wave_packet(mom=10),dt=-1e-1j,V=quadratic_potential,steps=200000,save_every=1000)
...
sim_quad_1 = simulate(Psi_1, dt=-1e-1j, condition=orthogonal_to([phi_0]), V=quadratic_potential, steps=200000, save_every=1000)
#anim = animate(sim_quad_1,init_func=quadratic_init)


sim = simulate(Psi_1, dt=-1e-1j, V=quadratic_potential,steps=200000,save_every=1000)
anim = animate(sim,init_func=quadratic_init)
